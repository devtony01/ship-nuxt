...
describe('signup API Component Tests', () => {
  ...
  describe('constants and Types', () => {
    it('should have email verification constants', async () => {
      try {
        const { EMAIL_VERIFICATION_TOKEN } = await import('@ship-nuxt/app-constants');
