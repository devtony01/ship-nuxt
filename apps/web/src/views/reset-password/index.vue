        ...
        <div class="card-body space-y-4">
          ...
          <div class="form-control">
            ...
            <input
              ...
              placeholder="Enter new password" autocomplete="new-password" required :aria-invalid="!!errors.password"
          ...
          <div class="form-control mt-6">
            <button
              type="submit" :disabled="isLoading || !password || !token"
              class="btn btn-primary w-full" :class="[{ 'btn-disabled': isLoading || !password || !token, loading: isLoading }]"
            >
