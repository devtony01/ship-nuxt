...
const onResendEmail = () => {
  ...
  resendEmail(
    { email: email.value },
    {
      ...
      onError: (e: ApiError) => {
        handleApiError(e)
        // For resend email, we don't need to set apiErrors since it's a separate action
      },
    },
  )
}
      ...
      <form class="card bg-base-100 shadow-xl" novalidate @submit.prevent="onSubmit">
        <div class="card-body space-y-4">
          ...
          <div class="text-right">
            <RouterLink to="/forgot-password" class="link link-primary text-sm">
          ...
          <div class="form-control mt-6">
            <button
              ...
              :class="[{ 'btn-disabled': isLoading || !email || !password, loading: isLoading }]"
            >
